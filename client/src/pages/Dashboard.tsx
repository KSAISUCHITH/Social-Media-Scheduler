...
import { dummyActivityData, dummyPostsData,dummyAccountsData } from "../assets/assets";
...
const Dashboard = () => {
  ...
  const [activities,setActivities] = useState<any[]>([])
    ...
    useEffect(()=>{
      const fetchDashboardData= async()=>{
          try{
              const [postsRes,accountsRes,activityRes] = [{data: dummyPostsData},
  ...
  return (<div className='space-y-8'>
      ...
      <div>
        ...
        <p className='text-slate-500 text-sm mt-0.5'>Here's what's happening with your social Media Account today.</p>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
          ...
          {activities.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 px-6">
              ...
              <p className="text-slate-400 text-sm mt-1">Connected accounts and schedule posts to see events here.</p>
            </div>
          ):(
