  ...
  <div className="max-w-4xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
    ...
    <div className="space-y-6 text-center mt-20">
      ...
      <div className="relative group mt-12">
        <textarea
        className="w-full px-6 py-6 bg-white border border-slate-300 rounded-xl text-slate-900 
          ...
          <button onClick={()=> setGenerateImage(!generateImage)}
           className="flex items-center gap-3 bg-red-50 py-2 px-3 rounded-lg">
            ...
            <div className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer
              rounded-full transition-full transition-colors duration-200 ease-in-out focus:outline-none
                                ...
                                <div className="space-y-6">
                                  <div>
                                    ...
                                    <div className="flex flex-wrap gap-2 ">
                                      {PLATFORMS.map((p)=>{
                                        ...
                                        return(
                                          <button key={p.id}
                                          onClick={()=>setSelectedPlatforms((prev)=>(prev.includes(p.id) ?
                                  ...
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="relative">
                                      ...
                                      rounded-md text-slate-900 text-sm focus:outline-none transition-all"  value={scheduledDate}
                                      ...
                                      rounded-md text-slate-900 text-sm focus:outline-none transition-all"  value={scheduledTime}
